...
| SkillCatalog | Service | [Catalog.Add / Catalog.Owner](../../internal/domain/model/catalog.go) — Разрешает коллизии скилов, находит владельца пути | нет | [условия](../../internal/domain/model/usecases.md), [сценарии](../../internal/domain/model/TESTS.md) |
